...
//Criando um servidor
//nele vamos adicionar um serviço, para isso temos que ter uma implementação do servico!
fun main() {
...
//Será a implementação do serviço FuncionarioService que tá descrito no arquivo .proto
